                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="admin/dist/img/user7-128x128.jpg">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="admin/dist/img/user5-128x128.jpg">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="admin/dist/img/user6-128x128.jpg">
                                ...
                                <div class="card-footer bg-transparent">
                                    <div class="row">
                                        <div class="col-4 text-center">
                                            ...
                                            <div class="text-white">Timber</div>
                                        </div>
                                        <!-- ./col -->
                                        <div class="col-4 text-center">
                                            ...
                                            <div class="text-white">Offcuts</div>
                                        </div>
                                        <!-- ./col -->
                                        <div class="col-4 text-center">
                                            ...
                                            <div class="text-white">Stumps</div>
                                        </div>
                                        <!-- ./col -->
                                    </div>
                                    <!-- /.row -->
